...
export default function SelfTestPanel() {
  ...
  return (
    <div className="w-full max-w-2xl mx-auto">
      {/* Top compact AI Buddy Banner */}
      <div className="flex items-center justify-between bg-gradient-to-r from-blue-500 to-purple-500 rounded-xl shadow p-3 mb-5">
        <div className="flex items-center gap-3">
          <FaRobot className="text-2xl text-white drop-shadow" />
          <div>
            <div className="text-lg font-bold text-white leading-tight">AI Buddy</div>
            <div className="text-white/80 text-xs">Your personal AI-powered English learning assistant.</div>
          </div>
        </div>
      ...
      {/* Main Card: Only Assessment/Exam/Practice content, no intro */}
      <div className="bg-white/90 rounded-2xl shadow-lg p-6">
        ...
        {mode==='exam' && !showResult && (
          <div className="space-y-4 animate-fade-in">
            ...
            <button
              className="w-full bg-gradient-to-r from-blue-500 to-purple-500 text-white px-6 py-3 rounded-xl font-bold text-lg shadow hover:scale-105 transition"
            ...
            {questions.length > 0 && (
              <form onSubmit={handleSubmit} className="space-y-4 mt-4">
                ...
                <button type="submit" className="w-full bg-gradient-to-r from-blue-500 to-purple-500 text-white px-6 py-3 rounded-xl font-bold text-lg shadow hover:scale-105 transition">
                  Submit Answers
                </button>
              </form>
            )}
