...
func Routers(e *gin.RouterGroup) {
	...
	homeGroup.GET("/public/tags", home.PublicTags)
	homeGroup.GET("/welcome", home.Welcome)
	homeGroup.POST("/register", home.Register)
	homeGroup.POST("/register/withTags", home.WithTagsAfterReg)
	...
	authGroup.GET("/course/meeting/note/fetchAll", auth.CourseMeetingNodeFetchAll)

	authGroup.POST("/course/bind_student", auth.CourseBindStudent)
	...
	authGroup.GET("/planner/view", auth.ViewStageGoal)
	...
	authGroup.GET("/interest/fetch", auth.FetchInterest)
	authGroup.POST("/interest/update", auth.UpdateInterest)
	...
	teacherAuthGroup.POST("/course/time/leaveConfirm", auth.TeacherLeaveConfirm)
	teacherAuthGroup.POST("/course/time/leaveReject", auth.TeacherLeaveReject)
