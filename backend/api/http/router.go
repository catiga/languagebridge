...
func Routers(e *gin.RouterGroup) {
	...
	authGroup.POST("/aiagent/assessment/studyplan/template/update", auth.UpdateStudyPlanTemplate)
	authGroup.GET("/aiagent/assessment/latest", auth.LatestAssessment)
	authGroup.GET("/aiagent/planner/course/recommend", auth.PlannerCourseRecommend)
